...
/**
 * Temporary pre-production import/seeder receipt retained until the Phase 10
 * demo-data adapter is moved fully onto InventoryOperation.
 *
 * Runtime inventory receiving uses InventoryOperation exclusively.
 *
 * @property int $id
