...
final class BillResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            ...
            Select::make('purchase_order_id')->relationship('purchaseOrder', 'order_number')->searchable()->preload()->live(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('purchaseOrder.order_number')->label('Purchase order')->searchable(),
