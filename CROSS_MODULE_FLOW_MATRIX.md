...
|---|---|---|---|
| Sales ↔ Inventory ↔ Accounting (the money spine) | 15 | 11 | 4 |
| Purchasing ↔ Inventory ↔ Accounting | 9 | 8 | 1 |
| CRM ↔ Sales | 6 | 1 | 5 |
| Support ↔ Maintenance ↔ Inventory ↔ Accounting | 7 | 4 | 3 |
| Employees ↔ CRM ↔ Sales ↔ Payroll | 6 | 5 | 1 |
| Inventory internal (condition, reservation, correction) | 8 | 3 | 5 |
| Cross-cutting (audit, notification, reporting, close) | 9 | 1 | 8 |
| **Total** | **60** | **33** | **27** |
...
**The accountability layer around it is not.** Twenty-seven of the sixty seams are impaired, and they
