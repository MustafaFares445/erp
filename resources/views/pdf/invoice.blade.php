...
<table class="meta">
    <tr><td><strong>Customer</strong></td><td>{{ $invoice->customer?->company_name }}</td></tr>
    <tr><td><strong>Invoice date</strong></td><td>{{ $invoice->invoice_date?->format('Y-m-d') }}</td></tr>
...
<table class="totals">
    <tr><td class="label">Subtotal</td><td class="number">{{ number_format((float) $invoice->subtotal, 2) }}</td></tr>
    <tr><td class="label">Tax total</td><td class="number">{{ number_format((float) $invoice->tax_total, 2) }}</td></tr>
    <tr><td class="label">Grand total</td><td class="number">{{ number_format((float) $invoice->total_amount, 2) }}</td></tr>
    <tr><td class="label">Paid</td><td class="number">{{ number_format((float) $invoice->amount_paid, 2) }}</td></tr>
    <tr><td class="label">Outstanding</td><td class="number">{{ number_format($invoice->outstandingAmount(), 2) }}</td></tr>
</table>
</body>
</html>
